      ...
      <div>
        <div style="font-size:1.65rem;font-weight:900;letter-spacing:-0.02em; display:flex; align-items:center; gap:0.75rem;">
          ...
          <?php if ($usr['plano'] !== 'premium'): ?>
            <a href="meu_plano.php" class="badge-hc badge-purple" style="font-size:0.7rem; padding:0.2rem 0.6rem; text-decoration:none;">
              <i class="bi bi-coin"></i> <?= $usr['token_saldo'] ?> Tokens
            </a>
          <?php endif; ?>
        </div>
