    ...
    <div class="d-flex jc-between ai-center mb-md" style="flex-wrap:wrap;gap:1rem;">
      ...
      <div class="d-flex gap-md">
        ...
        <button onclick="refinarComIA()" class="btn-hc btn-ai shadow-neon">
            <i class="bi bi-stars"></i> Refinar com IA (98% precisão)
        </button>
...
async function refinarComIA() {
    const msg = "<?= $_SESSION['plano'] === 'premium' ? 'Deseja refinar seu plano com IA agora?' : 'O refinamento estratégico consome 1 Token. Deseja continuar?' ?>";
