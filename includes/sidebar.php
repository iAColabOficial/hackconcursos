...
<?php if (!$is_admin): ?>
    ...
    <?= sidebarItem($base . '/upload_edital.php', 'pencil-square',   'Novo Concurso',     $current_page) ?>
...
<?php endif; ?>
  ...
  <div style="padding:1rem 1.25rem;border-top:1px solid var(--border-glass);">
    <?php
    $plano_label = ['free'=>'Padrão','basico'=>'Básico','premium'=>'Premium ⚡'];
    $plano_class = ['free'=>'badge-blue','basico'=>'badge-blue','premium'=>'badge-purple'];
